...
{$DEFINE BldOwnClasses_unitheader}
{$INCLUDE BldOwnClasses_Interface.inc}
...
initialization
  CodeDescriptor := GeneratedCodes.AddGeneratedCodeDescriptorWithFunc('BldOwnClasses', InstallBusinessClasses, InstallObjectListClasses, GeneratedCodeCRC);
finalization
