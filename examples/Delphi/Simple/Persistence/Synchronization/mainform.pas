...
uses
  ...
  ActnList,
  BoldHandleAction,
  BoldActions, BoldDBActions, BoldIBDatabaseAction;
...
begin
  ShowMessage('This example needs a valid license for ObjectSpace Synchronization Server Extension. If you miss the key request it in the License Manager found in the About box.');
end;
