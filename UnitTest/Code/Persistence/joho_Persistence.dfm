object dmjohoPersistence: TdmjohoPersistence
  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9'""'
        ...
        #9'"_Boldify.boldified=True,_BoldInternal.flattened=True,Bold.Delp' +
        'hiName=<Name>,Bold.RootClass=BusinessClassesRoot,Bold.UseReadOnl' +
        'y=False"'
      #9'(Classes'
      #9#9'(Class'
