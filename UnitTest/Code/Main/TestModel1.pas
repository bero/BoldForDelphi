...
{$DEFINE TestModel1_unitheader}
{$INCLUDE TestModel1_Interface.inc}
...
function TChildMapped._Get_M_c: TBAString;
begin
  assert(ValidateMember('TChildMapped', 'c', 0, TBAString));
  Result := TBAString(BoldMembers[0]);
end;

function TChildMapped._Getc: String;
begin
  Result := M_c.AsString;
end;

procedure TChildMapped._Setc(const NewValue: String);
begin
  M_c.AsString := NewValue;
end;

function TChildMapped._Get_M_Own: TBoldObjectReference;
begin
  assert(ValidateMember('TChildMapped', 'Own', 1, TBoldObjectReference));
  Result := TBoldObjectReference(BoldMembers[1]);
end;

function TChildMapped._GetOwn: TOwn;
begin
  Result := TOwn(M_Own.BoldObject);
  assert(not assigned(Result) or (Result is TOwn), SysUtils.format(BoldMemberAssertInvalidObjectType, [ClassName, 'Own', Result.ClassName, 'TOwn']));
end;

procedure TChildMapped._SetOwn(const value: TOwn);
begin
  M_Own.BoldObject := value;
end;
...
function TChildMappedList.AddNew: TChildMapped;
begin
  result := TChildMapped(InternalAddNew);
end;
...
begin
  result := TChildMapped(GetElement(index));
end;
...
{$IFDEF UseBoldListEnumerator}
function TChildMappedList.GetEnumerator: TChildMappedListEnumerator;
begin
 Result := TChildMappedListEnumerator.Create(Self);
end;

function TChildMappedListEnumerator.GetCurrent: TChildMapped;
begin
 Result := List[Index] as TChildMapped;
end;
...
function TItem._Get_M_CompositeItem: TBoldObjectReference;
begin
  assert(ValidateMember('TItem', 'CompositeItem', 0, TBoldObjectReference));
  Result := TBoldObjectReference(BoldMembers[0]);
end;

function TItem._GetCompositeItem: TCompositeItem;
begin
  Result := TCompositeItem(M_CompositeItem.BoldObject);
  assert(not assigned(Result) or (Result is TCompositeItem), SysUtils.format(BoldMemberAssertInvalidObjectType, [ClassName, 'CompositeItem', Result.ClassName, 'TCompositeItem']));
end;

procedure TItem._SetCompositeItem(const value: TCompositeItem);
begin
  M_CompositeItem.BoldObject := value;
end;
...
{$IFDEF UseBoldListEnumerator}
function TItemList.GetEnumerator: TItemListEnumerator;
begin
 Result := TItemListEnumerator.Create(Self);
end;

function TItemListEnumerator.GetCurrent: TItem;
begin
 Result := List[Index] as TItem;
end;
...
function TOwn._GetParentMapped2: TParentMapped2List;
begin
  assert(ValidateMember('TOwn', 'ParentMapped2', 0, TParentMapped2List));
  Result := TParentMapped2List(BoldMembers[0]);
end;

function TOwn._GetChildMapped: TChildMappedList;
begin
  assert(ValidateMember('TOwn', 'ChildMapped', 1, TChildMappedList));
  Result := TChildMappedList(BoldMembers[1]);
end;

procedure TOwnList.Add(NewObject: TOwn);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TOwnList.IndexOf(anObject: TOwn): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TOwnList.Includes(anObject: TOwn) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TOwnList.AddNew: TOwn;
begin
  result := TOwn(InternalAddNew);
end;

procedure TOwnList.Insert(index: Integer; NewObject: TOwn);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TOwnList.GetBoldObject(index: Integer): TOwn;
begin
  result := TOwn(GetElement(index));
end;

procedure TOwnList.SetBoldObject(index: Integer; NewObject: TOwn);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TOwnList.GetEnumerator: TOwnListEnumerator;
begin
 Result := TOwnListEnumerator.Create(Self);
end;

function TOwnListEnumerator.GetCurrent: TOwn;
begin
 Result := List[Index] as TOwn;
end;
...
function TParentList.AddNew: TParent;
begin
  result := TParent(InternalAddNew);
end;
...
begin
  result := TParent(GetElement(index));
end;
...
{$IFDEF UseBoldListEnumerator}
function TParentList.GetEnumerator: TParentListEnumerator;
begin
 Result := TParentListEnumerator.Create(Self);
end;

function TParentListEnumerator.GetCurrent: TParent;
begin
 Result := List[Index] as TParent;
end;
...
function TSomething._Get_M_aDerivedString: TBAString;
begin
  assert(ValidateMember('TSomething', 'aDerivedString', 0, TBAString));
  Result := TBAString(BoldMembers[0]);
end;

function TSomething._GetaDerivedString: String;
begin
  Result := M_aDerivedString.AsString;
end;

procedure TSomethingList.Add(NewObject: TSomething);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TSomethingList.IndexOf(anObject: TSomething): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TSomethingList.Includes(anObject: TSomething) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TSomethingList.AddNew: TSomething;
begin
  result := TSomething(InternalAddNew);
end;

procedure TSomethingList.Insert(index: Integer; NewObject: TSomething);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TSomethingList.GetBoldObject(index: Integer): TSomething;
begin
  result := TSomething(GetElement(index));
end;

procedure TSomethingList.SetBoldObject(index: Integer; NewObject: TSomething);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TSomethingList.GetEnumerator: TSomethingListEnumerator;
begin
 Result := TSomethingListEnumerator.Create(Self);
end;

function TSomethingListEnumerator.GetCurrent: TSomething;
begin
 Result := List[Index] as TSomething;
end;
...
function TThing._Getmany2: TThingList;
begin
  assert(ValidateMember('TThing', 'many2', 5, TThingList));
  Result := TThingList(BoldMembers[5]);
end;

function TThing._Get_M_one2: TBoldObjectReference;
begin
  assert(ValidateMember('TThing', 'one2', 6, TBoldObjectReference));
  Result := TBoldObjectReference(BoldMembers[6]);
end;

function TThing._Getone2: TThing;
begin
  Result := TThing(M_one2.BoldObject);
  assert(not assigned(Result) or (Result is TThing), SysUtils.format(BoldMemberAssertInvalidObjectType, [ClassName, 'one2', Result.ClassName, 'TThing']));
end;

procedure TThing._Setone2(const value: TThing);
begin
  M_one2.BoldObject := value;
end;
...
procedure TChild1List.Add(NewObject: TChild1);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TChild1List.IndexOf(anObject: TChild1): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TChild1List.Includes(anObject: TChild1) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TChild1List.AddNew: TChild1;
begin
  result := TChild1(InternalAddNew);
end;

procedure TChild1List.Insert(index: Integer; NewObject: TChild1);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TChild1List.GetBoldObject(index: Integer): TChild1;
begin
  result := TChild1(GetElement(index));
end;

procedure TChild1List.SetBoldObject(index: Integer; NewObject: TChild1);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TChild1List.GetEnumerator: TChild1ListEnumerator;
begin
 Result := TChild1ListEnumerator.Create(Self);
end;

function TChild1ListEnumerator.GetCurrent: TChild1;
begin
 Result := List[Index] as TChild1;
end;
...
procedure TChild2List.Add(NewObject: TChild2);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TChild2List.IndexOf(anObject: TChild2): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TChild2List.Includes(anObject: TChild2) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TChild2List.AddNew: TChild2;
begin
  result := TChild2(InternalAddNew);
end;

procedure TChild2List.Insert(index: Integer; NewObject: TChild2);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TChild2List.GetBoldObject(index: Integer): TChild2;
begin
  result := TChild2(GetElement(index));
end;

procedure TChild2List.SetBoldObject(index: Integer; NewObject: TChild2);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TChild2List.GetEnumerator: TChild2ListEnumerator;
begin
 Result := TChild2ListEnumerator.Create(Self);
end;

function TChild2ListEnumerator.GetCurrent: TChild2;
begin
 Result := List[Index] as TChild2;
end;
...
function TCompositeItem._Get_M_Name: TBAString;
begin
  assert(ValidateMember('TCompositeItem', 'Name', 1, TBAString));
  Result := TBAString(BoldMembers[1]);
end;

function TCompositeItem._GetName: String;
begin
  Result := M_Name.AsString;
end;

procedure TCompositeItem._SetName(const NewValue: String);
begin
  M_Name.AsString := NewValue;
end;

function TCompositeItem._GetItem: TItemList;
begin
  assert(ValidateMember('TCompositeItem', 'Item', 2, TItemList));
  Result := TItemList(BoldMembers[2]);
end;

procedure TCompositeItemList.Add(NewObject: TCompositeItem);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TCompositeItemList.IndexOf(anObject: TCompositeItem): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TCompositeItemList.Includes(anObject: TCompositeItem) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TCompositeItemList.AddNew: TCompositeItem;
begin
  result := TCompositeItem(InternalAddNew);
end;

procedure TCompositeItemList.Insert(index: Integer; NewObject: TCompositeItem);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TCompositeItemList.GetBoldObject(index: Integer): TCompositeItem;
begin
  result := TCompositeItem(GetElement(index));
end;

procedure TCompositeItemList.SetBoldObject(index: Integer; NewObject: TCompositeItem);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TCompositeItemList.GetEnumerator: TCompositeItemListEnumerator;
begin
 Result := TCompositeItemListEnumerator.Create(Self);
end;

function TCompositeItemListEnumerator.GetCurrent: TCompositeItem;
begin
 Result := List[Index] as TCompositeItem;
end;
...
function TSingleItem._Get_M_Name: TBAString;
begin
  assert(ValidateMember('TSingleItem', 'Name', 1, TBAString));
  Result := TBAString(BoldMembers[1]);
end;

function TSingleItem._GetName: String;
begin
  Result := M_Name.AsString;
end;

procedure TSingleItem._SetName(const NewValue: String);
begin
  M_Name.AsString := NewValue;
end;

procedure TSingleItemList.Add(NewObject: TSingleItem);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TSingleItemList.IndexOf(anObject: TSingleItem): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TSingleItemList.Includes(anObject: TSingleItem) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TSingleItemList.AddNew: TSingleItem;
begin
  result := TSingleItem(InternalAddNew);
end;

procedure TSingleItemList.Insert(index: Integer; NewObject: TSingleItem);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TSingleItemList.GetBoldObject(index: Integer): TSingleItem;
begin
  result := TSingleItem(GetElement(index));
end;

procedure TSingleItemList.SetBoldObject(index: Integer; NewObject: TSingleItem);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TSingleItemList.GetEnumerator: TSingleItemListEnumerator;
begin
 Result := TSingleItemListEnumerator.Create(Self);
end;

function TSingleItemListEnumerator.GetCurrent: TSingleItem;
begin
 Result := List[Index] as TSingleItem;
end;
...
function TParentMapped1._Get_M_a: TBAString;
begin
  assert(ValidateMember('TParentMapped1', 'a', 0, TBAString));
  Result := TBAString(BoldMembers[0]);
end;

function TParentMapped1._Geta: String;
begin
  Result := M_a.AsString;
end;

procedure TParentMapped1._Seta(const NewValue: String);
begin
  M_a.AsString := NewValue;
end;

procedure TParentMapped1List.Add(NewObject: TParentMapped1);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TParentMapped1List.IndexOf(anObject: TParentMapped1): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TParentMapped1List.Includes(anObject: TParentMapped1) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TParentMapped1List.AddNew: TParentMapped1;
begin
  result := TParentMapped1(InternalAddNew);
end;

procedure TParentMapped1List.Insert(index: Integer; NewObject: TParentMapped1);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TParentMapped1List.GetBoldObject(index: Integer): TParentMapped1;
begin
  result := TParentMapped1(GetElement(index));
end;

procedure TParentMapped1List.SetBoldObject(index: Integer; NewObject: TParentMapped1);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TParentMapped1List.GetEnumerator: TParentMapped1ListEnumerator;
begin
 Result := TParentMapped1ListEnumerator.Create(Self);
end;

function TParentMapped1ListEnumerator.GetCurrent: TParentMapped1;
begin
 Result := List[Index] as TParentMapped1;
end;
...
function TParentMapped2._Get_M_b: TBAInteger;
begin
  assert(ValidateMember('TParentMapped2', 'b', 0, TBAInteger));
  Result := TBAInteger(BoldMembers[0]);
end;

function TParentMapped2._Getb: Integer;
begin
  Result := M_b.AsInteger;
end;

procedure TParentMapped2._Setb(const NewValue: Integer);
begin
  M_b.AsInteger := NewValue;
end;

function TParentMapped2._Get_M_Own: TBoldObjectReference;
begin
  assert(ValidateMember('TParentMapped2', 'Own', 1, TBoldObjectReference));
  Result := TBoldObjectReference(BoldMembers[1]);
end;

function TParentMapped2._GetOwn: TOwn;
begin
  Result := TOwn(M_Own.BoldObject);
  assert(not assigned(Result) or (Result is TOwn), SysUtils.format(BoldMemberAssertInvalidObjectType, [ClassName, 'Own', Result.ClassName, 'TOwn']));
end;

procedure TParentMapped2._SetOwn(const value: TOwn);
begin
  M_Own.BoldObject := value;
end;

procedure TParentMapped2List.Add(NewObject: TParentMapped2);
begin
  if Assigned(NewObject) then
    AddElement(NewObject);
end;

function TParentMapped2List.IndexOf(anObject: TParentMapped2): Integer;
begin
  result := IndexOfElement(anObject);
end;

function TParentMapped2List.Includes(anObject: TParentMapped2) : Boolean;
begin
  result := IncludesElement(anObject);
end;

function TParentMapped2List.AddNew: TParentMapped2;
begin
  result := TParentMapped2(InternalAddNew);
end;

procedure TParentMapped2List.Insert(index: Integer; NewObject: TParentMapped2);
begin
  if assigned(NewObject) then
    InsertElement(index, NewObject);
end;

function TParentMapped2List.GetBoldObject(index: Integer): TParentMapped2;
begin
  result := TParentMapped2(GetElement(index));
end;

procedure TParentMapped2List.SetBoldObject(index: Integer; NewObject: TParentMapped2);
begin;
  SetElement(index, NewObject);
end;

{$IFDEF UseBoldListEnumerator}
function TParentMapped2List.GetEnumerator: TParentMapped2ListEnumerator;
begin
 Result := TParentMapped2ListEnumerator.Create(Self);
end;

function TParentMapped2ListEnumerator.GetCurrent: TParentMapped2;
begin
 Result := List[Index] as TParentMapped2;
end;
...
begin
  ...
  BoldObjectListClasses.AddObjectEntry('Own', TOwnList);
  BoldObjectListClasses.AddObjectEntry('Parent', TParentList);
  BoldObjectListClasses.AddObjectEntry('Something', TSomethingList);
  ...
  BoldObjectListClasses.AddObjectEntry('Child1', TChild1List);
  BoldObjectListClasses.AddObjectEntry('Child2', TChild2List);
  BoldObjectListClasses.AddObjectEntry('CompositeItem', TCompositeItemList);
  BoldObjectListClasses.AddObjectEntry('SingleItem', TSingleItemList);
  BoldObjectListClasses.AddObjectEntry('ParentMapped1', TParentMapped1List);
  BoldObjectListClasses.AddObjectEntry('ParentMapped2', TParentMapped2List);
end;
...
begin
  ...
  BoldObjectClasses.AddObjectEntry('Own', TOwn);
  BoldObjectClasses.AddObjectEntry('Parent', TParent);
  BoldObjectClasses.AddObjectEntry('Something', TSomething);
  ...
  BoldObjectClasses.AddObjectEntry('Child1', TChild1);
  BoldObjectClasses.AddObjectEntry('Child2', TChild2);
  BoldObjectClasses.AddObjectEntry('CompositeItem', TCompositeItem);
  BoldObjectClasses.AddObjectEntry('SingleItem', TSingleItem);
  BoldObjectClasses.AddObjectEntry('ParentMapped1', TParentMapped1);
  BoldObjectClasses.AddObjectEntry('ParentMapped2', TParentMapped2);
end;
...
initialization
  CodeDescriptor := GeneratedCodes.AddGeneratedCodeDescriptorWithFunc('TestModel1', InstallBusinessClasses, InstallObjectListClasses, GeneratedCodeCRC);
finalization
