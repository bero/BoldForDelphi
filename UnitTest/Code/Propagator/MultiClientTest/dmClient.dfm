object dm: Tdm
  ...
  object BoldListenerHandle1: TBoldListenerHandle
    ...
    ClientIdentifierString = 'TestClient'
    PropagatorHandle = BoldPropagatorHandleCOM1
    Left = 432
    Top = 294
  end
  ...
  object BoldListHandle1: TBoldListHandle
    StaticSystemHandle = dmUndoRedo.BoldSystemHandle1
    Left = 432
    Top = 228
  end
  ...
  object BoldPropagatorHandleCOM1: TBoldPropagatorHandleCOM
    Active = True
    ConnectionHandle = bcchPropagator
    Left = 72
    Top = 128
  end
  object bcchPropagator: TBoldComConnectionHandle
    AutoConnect = True
  ...
  object AutoTestTimer: TTimer
    Enabled = False
    Interval = 2000
    OnTimer = AutoTestTimerTimer
    Left = 488
    Top = 384
  end
