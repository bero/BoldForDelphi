object dmTemporalTest: TdmTemporalTest
  Height = 335
  Width = 499
  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9#9#9#9#9'2'
      #9#9#9#9#9'0'
      #9#9#9#9#9'"Bold.Embed=False,Bold.Ordered=True"'
      #9#9#9#9#9'(Qualifiers'
      #9#9#9#9#9')'
      #9#9#9#9')'
      #9#9#9#9'(Role'
