object dmTestCase1: TdmTestCase1
  ...
  object BoldModel1: TBoldModel
    ...
    Model = (
      ...
      #9#9#9#9#9'2'
      #9#9#9#9#9'""'
      #9#9#9#9#9'"Bold.PMapper=<Default>,Bold.OperationKind=Override"'
      #9#9#9#9')'
      #9#9#9')'
      #9#9')'
      #9')'
