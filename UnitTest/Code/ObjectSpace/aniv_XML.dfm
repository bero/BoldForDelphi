object dmXMLTest: TdmXMLTest
  ...
  object BoldSystemHandle1: TBoldSystemHandle
    ...
    Active = False
    PersistenceHandle = BoldSOAPClientPersistenceHandle1
    Left = 80
    Top = 32
  end
  object BoldSOAPServerPersistenceHandle1: TBoldSOAPServerPersistenceHandle
    ObjectName = 'bssphXMLTest'
    ServerClass = 'BoldXMLTestServer'
    ServerHandle = BoldComServerHandle1
    BoldHandle = BoldPersistenceHandleDB1
  ...
  object BoldComServerHandle1: TBoldComServerHandle
    Classes = <
      item
        CLSID = '{EAD191C3-7A8C-11D4-BBAC-0010A4F9E114}'
        Description = 'Bold test of XML streaming'
        Name = 'BoldXMLTestServer'
      end>
    Left = 256
    Top = 152
  end
  object BoldComConnectionHandle1: TBoldComConnectionHandle
    ServerCLSID = '{EAD191C3-7A8C-11D4-BBAC-0010A4F9E114}'
    ServerName = 'ANIV_TESTS.BoldXMLTestServer'
    Left = 256
    Top = 96
  end
  ...
  object BoldDatabaseAdapterUniDAC1: TBoldDatabaseAdapterUniDAC
    ...
    SQLDatabaseConfig.DatabaseExistsTemplate = 
      'SELECT name FROM master.sys.databases WHERE name = N'#39'<DatabaseNa' +
      'me>'#39
