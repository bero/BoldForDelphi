...
begin
  ...
  begin
    ...
    CheckCompareTypes(m_aString,m_aString, [ctDefault, ctCaseSensitive, ctCaseInsensitive]);
    ...
    CheckCompareTypes(m_aBlob,m_aBlob,[ctDefault,ctCaseSensitive, ctCaseInsensitive]);
    CheckCompareTypes(m_aBlobContent,m_aBlobContent,[ctDefault,ctCaseSensitive, ctCaseInsensitive]);
  end;
TestClass.delete;
end;
//(ctDefault, ctAsText, ctAsAnsiString, ctAsAnsiText, ctAsDate, ctAsTime);
